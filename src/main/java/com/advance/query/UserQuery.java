...
public class UserQuery {
	...
	public static final String DELETE_USER_FROM_PASSWORD_VERIFICATION_QUERY = "DELETE FROM ResetPasswordVerifications WHERE user_id = :userId";
	...
	public static final String DELETE_VERIFICATION_CODE_BY_URL_QUERY = "DELETE FROM ResetPasswordVerifications WHERE url = :url";
	...
	public static final String UPDATE_USER_IMAGE_QUERY = "UPDATE Users SET image_url = :image WHERE id = :userId";
}
